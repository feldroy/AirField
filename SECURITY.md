...
If you find a security vulnerability in AirField, please report it through [GitHub's private vulnerability reporting](https://github.com/feldroy/AirField/security/advisories/new). This keeps the details private while we work on a fix.
